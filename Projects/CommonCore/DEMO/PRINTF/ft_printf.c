...
/*   Updated: 2024/04/19 11:27:35 by aruckenb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	funk(va_list nex_arg, char s, int count)
{
	if (s == 'c')
		...
		return (ft_putnbr_count(va_arg(nex_arg, int)));
	else if (s == 'u')
