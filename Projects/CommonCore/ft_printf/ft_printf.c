...
/*   Updated: 2024/04/24 09:32:20 by aruckenb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main ()
{
    ...
    int i = -2147483649;
    void *pt = NULL;
    char *test = " this is not %c a %s %%x %u %d %p\n%Y";

    int a = printf(test, c, str, i, i, i, pt);
    int b = ft_printf(test, c, str, i, i, i, pt);

    // long long int z = 2147483649;
    // printf("%d\n", z);
    // ft_printf("%d\n", z);
