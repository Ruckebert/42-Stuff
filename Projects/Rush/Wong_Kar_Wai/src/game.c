...
void custom_colors()
{
	...
	init_color(CUSTOM_8, 237, 197, 63);
	init_color(CUSTOM_9, 237, 194, 46);
	...
	init_pair(512, WHITE, CUSTOM_7);
	init_pair(1024, WHITE, CUSTOM_8);
	init_pair(2048, WHITE, CUSTOM_9);
	init_pair(4096, WHITE, BLACK);
	init_pair(8192, WHITE, BLACK);
}
